...
if __name__ == '__main__':
    ...
    while Flag:
        mode1 = input('Please choose your game mode for Player 1: -1 for random, 0 for AI, 1 for human player and 2 for quit')
        mode2 = input('Please choose your game mode for Player 2: -1 for random, 0 for AI, 1 for human player and 2 for quit')
